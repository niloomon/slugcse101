...
subtitle: "University of California, Santa Cruz, QUARTER YEAR"
---

<!-- Keep the quotes around the title and the subtitle above. Without them a
     title that contains a colon is not valid YAML and the page fails to build. -->

**************************************************
### | [Overview](#overview)  |  [Schedule](#schedule)  | [Description](#description) | [Teaching Team](#teaching-team)  | [Assessment](#assessment) |

<!-- This is a placeholder banner. To use your own, drop the file in images/ and change the line below.
     The text in the brackets is the caption under the image, and the text in the quotes is the hover text. -->
![CAPTION FOR THE IMAGE (This image was generated by OpenAI ChatGPT.)](images/running_slugs.jpg "HOVER TEXT")
...
Instructor: [INSTRUCTOR NAME](INSTRUCTOR HOMEPAGE URL) <<INSTRUCTOR@ucsc.edu>>
Time: DAYS AND TIME
Location: BUILDING AND ROOM
TAs: TA NAME <<TA@ucsc.edu>>
Tutors: TUTOR NAME <<TUTOR@ucsc.edu>>

WELCOME PARAGRAPH. Say hello, then describe in a few sentences what the course is about, what students will be able to do by the end of it, and why the subject matters. Keep this to one paragraph on a single line.
...
<!-- Uncomment this section if the material comes from someone else's course.
## Acknowledgements

The material for this course is adopted from Professor [NAME](URL).
-->
...
<!-- If there is a repository of code from the lectures, uncomment the next line. -->
<!-- The example code snippets from the lectures are available at this [Code Repo](CODE REPO URL). -->

<!-- Put the lecture slides in the lectures/ folder, and link them from the Slides column like this:  [slides](lectures/L1.pdf) -->

## Module 1: MODULE 1 TITLE

| Date       | Topic                             | Slides |   Readings       | Event
| --------------- | ------------------------------- | -------- | -------------------- | --------------------
| MON DD | TOPIC                              |      |  READING |
| MON DD | TOPIC                              |      |  READING | HW#1 Release
...
| --------------- | ------------------------------- | -------- | -------------------- | --------------------
| MON DD | TOPIC                              |      |  READING |
| MON DD | TOPIC                              |      |  READING | HW#1 Deadline, HW#2 Release
...
| --------------- | ------------------------------- | -------- | -------------------- | --------------------
| MON DD |                                    |      |   | Midterm
| MON DD | TOPIC                              |      |  READING | HW#2 Deadline, HW#3 Release
...
| --------------- | ------------------------------- | -------- | -------------------- | --------------------
| MON DD | TOPIC                              |      |  READING |
| MON DD | TOPIC                              |      |  READING | HW#3 Deadline, HW#4 Release

## Module 5: MODULE 5 TITLE

| Date       | Topic                             | Slides |   Readings       | Event
| --------------- | ------------------------------- | -------- | -------------------- | --------------------
| MON DD | TOPIC                              |      |  READING | HW#4 Deadline
| MON DD | TOPIC                              |      |  READING | HW#5 Deadline
| MON DD, TIME, PLACE |                        |      |   | Final exam
...
SUMMARY PARAGRAPH. A longer version of the welcome blurb: what topics the course covers, how they fit together, and what skills the students walk away with. Keep it to one paragraph on a single line.
...
* [BOOK TITLE](BOOK URL)
WHY THIS BOOK IS USEFUL FOR THE COURSE.
* [BOOK TITLE](BOOK URL)
WHY THIS BOOK IS USEFUL FOR THE COURSE.

## Required Background

The prerequisites for this class are PREREQUISITE COURSES. You will need some foundation in all of those topics to succeed in this class. EXPLAIN WHY EACH PREREQUISITE MATTERS.
...
We have a great teaching staff this quarter! Please get to know them and take advantage of the office hours and mentoring sessions they provide.

## Office Hours:

### Instructor

[INSTRUCTOR NAME](INSTRUCTOR HOMEPAGE URL)
<<INSTRUCTOR@ucsc.edu>>
DAY, TIME. Office: BUILDING AND ROOM
...
If you are interested in seeing how these tools can help, please feel free to use them *after* you have submitted a non-AI version of the homework. We would be very interested in hearing about your experience, e.g., as a piazza post.
...
Everything written in CAPITALS above is a placeholder to fill in or delete.

Keep each paragraph on a single long line. A line break in the middle of a
paragraph shows up as a line break on the page.

Do not start a line with spaces or a tab, unless it is meant to be a bullet.
An indented line is turned into a bullet point.
-->
...
| Date       | Topic                             | Slides |   Readings       | Event
| ---------- | --------------------------------- | ------ | ---------------- | --------
| Sep 25     | The first lecture                 | [slides](lectures/L1.pdf) | Chapter 1 | HW#1 Release
-->
